...
## Objectives
This system can be used in many business parts/areas that may require expert candidates. This system will reduce the workload of the hiring professionals. It will help the recruiters to select the right candidate for the desired job profile, which in turn provide the expert candidate for the organization. Admin can easily shortlist a candidate based on their personality scores and select the appropriate candidate for a particular job profile.
...
## Description of Personality Perception
The Big Five Personality Traits Model measures five key dimensions of people's personalities:-

### Openness 
>It is sometimes called "Intellect" or "Imagination," which measures your level of creativity and your desire for knowledge and new experiences.
### Conscientiousness
>It looks at the level of care that you take in your life and work. If you score highly in conscientiousness, you'll likely be organized and thorough, and know how to make plans and follow them through. If you score low, you'll likely be lax and disorganized.
...
### Natural Reactions
>Sometimes called "Emotional Stability" or "Neuroticism," it measurea emotional reactions. Do you react negatively or calmly to bad news? Do you worry obsessively about small details, or are you relaxed in stressful situations?
...
train method: It read the dataset for training the model from a csv file and build a model using Logistic Regression. It uses 7 different values for training the model.
